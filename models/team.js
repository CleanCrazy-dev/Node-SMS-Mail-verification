...
teamSchema.methods.addMember = function (memberId, callback) {
  if (_.isUndefined(memberId))
    return callback('Invalid MemberId - TeamSchema.AddMember()');
...
teamSchema.methods.removeMember = function (memberId, callback) {
  if (_.isUndefined(memberId))
    return callback('Invalid MemberId - TeamSchema.RemoveMember()');
...
teamSchema.statics.getWithObject = function (obj, callback) {
  if (!obj)
    return callback({
      message: 'Invalid Team Object - TeamSchema.GetWithObject()',
    });
...
teamSchema.statics.getTeamByName = function (name, callback) {
  if (_.isUndefined(name) || name.length < 1)
    return callback('Invalid Team Name - TeamSchema.GetTeamByName()');
...
teamSchema.statics.getTeamsOfUser = function (userId, callback) {
  if (_.isUndefined(userId))
    return callback('Invalid UserId - TeamSchema.GetTeamsOfUser()');
...
teamSchema.statics.getTeamsOfUserNoPopulate = function (userId, callback) {
  if (_.isUndefined(userId))
    return callback('Invalid UserId - TeamSchema.GetTeamsOfUserNoPopulate()');
...
teamSchema.statics.getTeam = function (id, callback) {
  if (_.isUndefined(id))
    return callback('Invalid TeamId - TeamSchema.GetTeam()');
